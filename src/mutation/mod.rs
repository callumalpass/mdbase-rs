...
pub(crate) use service::{
    ...
    rename, staged_create, staged_delete, staged_update, update,
};
#[cfg(test)]
pub(crate) use service::{
    mutation_path_probes, probe_full_shadow, probe_legacy_parse, probe_request_value,
    probe_result_decode, probe_runtime_decode, probe_sparse_shadow, probe_wire_decode,
    reset_mutation_path_probes, MutationPathProbes,
};
